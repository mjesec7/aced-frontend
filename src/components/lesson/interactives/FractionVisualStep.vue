  ...
  <div class="interactive-step step-animate-in">
    ...
    <div class="flex flex-col sm:flex-row gap-8 justify-center items-center sm:items-start">
      ...
      <div class="flex flex-col items-center gap-3">
        ...
        <div 
          class="grid gap-2 bg-gray-100 dark:bg-gray-700 p-3 rounded-xl border border-gray-200 dark:border-gray-600 shadow-inner"
      ...
      <!-- Equals Sign -->
      <div class="text-4xl font-light text-gray-300 dark:text-gray-600 self-center hidden sm:block">=</div>
      ...
      <div class="flex flex-col items-center gap-3">
        ...
        <div 
          class="grid gap-2 bg-gray-100 dark:bg-gray-700 p-3 rounded-xl border border-gray-200 dark:border-gray-600 shadow-inner cursor-pointer"
        ...
        >
          <button
            ...
            :class="{
              ...
              'bg-white dark:bg-gray-600 border-gray-200 dark:border-gray-500 hover:border-blue-300 dark:hover:border-blue-500 hover:scale-105 active:scale-95': !active && status !== 'correct'
            }"
...
const buttonClass = computed(() => {
  if (status.value === 'correct') {
    return 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 ring-2 ring-green-500 ring-offset-2 cursor-default';
  }
  if (status.value === 'incorrect') {
    return 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 ring-2 ring-red-500 ring-offset-2';
  }
