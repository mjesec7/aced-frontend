<template>
  <section class="relative py-24 bg-white overflow-hidden" id="aced">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative z-10">
        ...
        <div v-if="loadingCourses" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="n in 6" :key="n" class="h-[420px] bg-white rounded-[2rem] border border-slate-100 shadow-sm animate-pulse flex items-center justify-center">
        ...
        <div v-else-if="displayedCourses.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div 
            ...
            :key="course._id"
            class="group relative bg-white rounded-[2rem] border-2 border-slate-50 overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-500/10 cursor-pointer flex flex-col h-full"
            :class="{
          ...
          >
            ...
            <div class="p-8 pb-4">
              <div class="flex justify-between items-start mb-6">
                <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm"
                  :class="{
            ...
            <div class="px-8 py-6 bg-slate-50/50 border-t border-slate-100 mt-4">
              <div class="flex items-center gap-6 mb-6 text-sm font-bold text-slate-600">
                <div class="flex items-center gap-2">
                  <div class="p-1.5 rounded-full bg-white shadow-sm text-indigo-500">
                ...
                <div class="flex items-center gap-2">
                  <div class="p-1.5 rounded-full bg-white shadow-sm text-purple-500">
                    <svg class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
        ...
        <!-- Empty State -->
        <div v-else class="text-center py-20 px-8 bg-white rounded-[2rem] border-2 border-slate-100 max-w-lg mx-auto">
          <div class="text-6xl mb-6 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">🔍</div>
      ...
      <div v-if="showRegistrationModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4" @click="closeRegistrationModal">
        ...
        <div class="relative w-full max-w-lg bg-white rounded-[2rem] shadow-2xl p-8 md:p-10 transform transition-all scale-100" @click.stop>
          ...
          <div class="text-center mb-8">
            ...
            <h2 class="text-3xl font-extrabold text-slate-900 mb-3">Premium Access</h2>
            <p class="text-slate-500">Registration is required to access this course</p>
          </div>
          
          <div v-if="selectedCourse" class="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 rounded-2xl p-6 mb-8">
