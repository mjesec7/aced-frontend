<template>
  <section class="py-24 bg-slate-50" id="aced">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative min-h-[400px]">
        ...
        <div v-else-if="displayedCourses.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            ...
            :key="course._id"
            class="group bg-white rounded-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 cursor-pointer flex flex-col h-full"
            ...
            <div class="p-6 flex-1">
              <div class="flex justify-between items-start mb-4">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium uppercase tracking-wide"
                  :class="{
                    'bg-indigo-50 text-indigo-700': getTopicType(course) === 'free',
                    'bg-purple-50 text-purple-700': getTopicType(course) === 'premium',
                    'bg-pink-50 text-pink-700': getTopicType(course) === 'pro'
                  }"
                >
      ...
      <div v-if="showRegistrationModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4" @click="closeRegistrationModal">
        ...
        <div class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 transform transition-all" @click.stop>
          ...
          <div class="text-center mb-6">
            <div class="w-12 h-12 bg-indigo-100 text-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">🎓</div>
          ...
          <div v-if="selectedCourse" class="bg-slate-50 rounded-xl p-4 mb-6 border border-slate-100">
          ...
          <div class="space-y-3">
            <button class="w-full py-3 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/20" @click="triggerRegistration">
              Create Free Account
            </button>
