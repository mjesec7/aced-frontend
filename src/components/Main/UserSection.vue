...
export default {
  ...
  methods: {
    ...
    try {
      ...
      console.log("🔑 Firebase token (preview):", token.slice(0, 30), "...");
      ...
      // ✅ Step 2: Fetch user from DB to confirm
      const { data } = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/users/${user.uid}`,
        {
