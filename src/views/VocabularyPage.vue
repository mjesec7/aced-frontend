  ...
  <div class="vocabulary-page">
    ...
    <div v-else-if="currentView === 'languages'" class="content-container">
      <div v-if="languages.length === 0" class="empty-state">
        ...
        <p class="empty-text">{{ $t('vocabulary.emptyText') }}</p>
        <p class="empty-subtext">{{ $t('vocabulary.emptySubtext') }}</p>
      </div>
          ...
          <div class="card-content">
            ...
            <div class="card-stats">
              <div class="stat-item">
                ...
                <span class="stat-label">{{ $t('vocabulary.words') }}</span>
              </div>
            ...
            <div class="progress-section">
              ...
              <span class="progress-text">{{ lang.progress }}{{ $t('vocabulary.learned') }}</span>
            </div>
          </div>
        </div>
      </div>
