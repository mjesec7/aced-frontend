...
export default {
  ...
  methods: {
    ...
    // ✅ REPLACE these 3 methods in CataloguePage.vue
...
// ✅ NEW HELPER METHOD: Calculate topic progress from lesson data
...
async loadLessonProgress() {
  ...
  try {
    ...
    try {
      ...
      console.warn('⚠️ Could not load lesson progress:', error.response?.status);
      this.lessonProgress = {};
    }
